                ...
                <div className="container">
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="reviews">
                            ...
                            <Link className="btn review-btn" data-toggle="modal" to="#review"><i className="fas fa-flag" /> Write Review</Link>
                            </div>	
                            <div className="review-content">		
                            ...
                            <p>Great clarity in specification and communication. I got payment really fast. Really recommend this employer for his professionalism. I will work for him again with pleasure.</p>
                            <Link className="btn review-btn grey-btn" data-toggle="modal" to="#editreview"><i className="fas fa-pencil-alt" /> Edit Review</Link>
                            </div>										
                        </div>
                        </div>
                    </div>
