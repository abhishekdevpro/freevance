                ...
                <div className="row">
                  <div className="col-md-3">
                    <nav className="nav flex-column setting-tab mb-5">
                      <Link className="nav-link active" to="#profile" data-toggle="tab">Profile</Link>
                      <Link className="nav-link" to="#password" data-toggle="tab">Password</Link>
                      <Link className="nav-link" to="#payment" data-toggle="tab">Payment &amp; Financials</Link>
                      <Link className="nav-link" to="#account" data-toggle="tab">Account</Link>
                    </nav>
                  </div>
                            ...
                            <form>
                              ...
                              <div className="form-row pro-pad">
                                ...
                                <div className="col-lg-12 text-right">
                                  <Link to="#" className="btn btn-primary click-btn">Update</Link>
                                </div>
                              </div>
                            </form>
                          </div>
                            ...
                            <form>
                                    ...
                                    <div className="pro-body">
                                      <h4 className="mb-3">Add Payment Methods</h4><h4>
                                        <nav className="nav nav-justified pay-tab">
                                          <Link className="nav-link active mr-1" to="#debit" data-toggle="tab"><i className="fa fa-plus-circle orange-text" aria-hidden="true" /> Add Debit or Credit Cards</Link>
                                          <Link className="nav-link" to="#paypal" data-toggle="tab"><i className="fa fa-plus-circle orange-text" aria-hidden="true" /> Add Paypal Account</Link>
                                        </nav>
                                          ...
                                          <div className="tab-pane fade" id="debit">
                                            <div className="form-row">
                                              ...
                                              <div className="col-md-8 btn-pad">
                                                <Link to="#" className="click-btn">Continue</Link>
                                              </div>
                                            </div>
                                          </div>
                              ...
                              <div className="form-row pro-pad">
                                ...
                                <div className="col-lg-12">
                                  <Link to="#" className="btn btn-primary click-btn">Save</Link>
                                </div>
                              </div>
                              <hr />
                              <div className="form-row pro-pad">
                                  ...
                                  <div className="tax-info">
                                    <div className="form-row tax-cont align-items-baseline">
                                      ...
                                      <div className="col-md-1">
                                        <Link to=""><i className="fa fa-window-close ml-2 orange-text" aria-hidden="true" /></Link>
                                      </div>									
                                    </div>
                                  </div>														
                                </div>
                                <div className="col-lg-12">
                                  <Link to="" className="btn bg-black btn-primary add-tax click-btn">+ Another Tax</Link>
                                </div>
                              </div>
                            </form>
                          </div>
                            ...
                            <form>
                              ...
                              <div className="form-row pro-pad">
                                ...
                                <div className="col-lg-12 mb-2">
                                  <Link to="#" className="btn btn-primary click-btn">Close My  Account</Link>
                                </div>
                                <div className="col-lg-12 text-right">
                                  <Link to="#" className="btn btn-primary click-btn">Update</Link>
                                </div>
