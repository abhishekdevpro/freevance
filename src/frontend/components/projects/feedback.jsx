                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      ...
                      <Link to="#" className="btn-primary btn-block click-btn">Submit</Link>
                    </div>
                  </div>
                </div>								
              </div>					
            ...
            <div className="col-md-6 col-lg-4">
              <div className="feedback-box">
                ...
                <div className="rating-type">
                  ...
                  <Link data-toggle="modal" to="#write-review" className="edit-text">Edit</Link>
                  <Link data-toggle="modal" to="#client_feedback" className="btn-primary click-btn">Reply</Link>
                </div>
              </div>
            </div>
            {/* /Feedback Box */}
