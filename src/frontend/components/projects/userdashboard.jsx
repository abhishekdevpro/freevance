            ...
            <div className="col-md-4 mb-5">
              <div className="myprofile-widget">
                <div className="myprofile-header">
                  ...
                  <Link to="#" className="btn member-btn">Free Member</Link>
                </div>
                <div className="myprofile-body">
                  ...
                  <div className="bal-card">
                    ...
                    <Link to="#" className="btn fund-btn">Deposit Funds</Link>
                  </div>
                </div>
              </div>					
            </div>	
            <div className="col-md-8 mb-5">
              <div className="pro-card">
                <div className="pro-head">
                  ...
                  <Link to="#" className="btn fund-btn">View All</Link>
                </div>
              ...
              <div className="pro-card">
                ...
                <div className="pro-body p-0">
                  <div className="dev-feature">
                    ...
                    <Link to="#" className="btn bid-btn">Bid now <i className="fas fa-long-arrow-alt-right" /></Link>
                  </div>
                  <div className="dev-feature">
                    <h4>Senior Wordpress Developer</h4>
                    <p>We are searching for a quality substance  essayist who can take up an undertaking</p>
