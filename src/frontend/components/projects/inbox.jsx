              ...
              <div className="chat-window mb-5">
                ...
                <div className="chat-cont-left">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom">
                    <li className="nav-item"><Link className="nav-link active" to="#chat1" data-toggle="tab">ACTIVE</Link></li>
                    <li className="nav-item"><Link className="nav-link" to="#chat2" data-toggle="tab">UNREAD (0)</Link></li>
                    <li className="nav-item"><Link className="nav-link" to="#chat3" data-toggle="tab">SUPPORT</Link></li>
                    <li className="nav-item"><Link className="nav-link" to="#chat4" data-toggle="tab"> ARCHIEVED</Link></li>
                  </ul>
