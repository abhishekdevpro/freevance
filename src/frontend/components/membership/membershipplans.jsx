                        ...
                        <div className="row">
                            <div className="col-md-12 text-center">
                                <ul className="nav btn-group tab-btn">
                                    <li className="nav-item btn in-btn "><Link className="nav-link active" to="#plan1" data-toggle="tab">Montly Plan</Link></li>
                                    <li className="nav-item btn out-btn "><Link className="nav-link" to="#plan2" data-toggle="tab">Annual Plan</Link></li>
                                </ul>
                                    ...
                                    <div className="tab-pane show active" id="plan1">
                                        ...
                                        <div className="column-5">							
                                            ...
                                            <ul className="price-features">
                                                ...
                                                <li>One listing submission</li>
                                                <li>One listing submission</li>
                                                <li className="footer-price"><Link to="#" className="btn btn-block plan-btn">Select Plan</Link></li>
                                            </ul>
                                            </div>
                                        </div>
                                        <div className="column-5">							
                                        ...
                                        <div className="column-5">							
                                            ...
                                            <ul className="price-features plus-price">
                                                ...
                                                <li>One listing submission</li>
                                                <li>One listing submission</li>
                                                <li className="footer-price"><Link to="#" className="btn btn-block plan-btn">Try Free Trial</Link></li>
                                            </ul>
                                            </div>
                                        </div>
                                        <div className="column-5">							
