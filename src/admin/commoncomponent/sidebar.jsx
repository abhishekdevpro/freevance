          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              <ul>
                ...
                <li
                  className={
                    pathname === "/admin/deposit"
                      ? "active"
                      : "" || pathname === "admin/deposit-pending"
                        ? "active"
                        : "" || pathname === "/admin/deposit-hold"
                          ? "active"
                          : "" || pathname === "/admin/deposit-cancelled"
                            ? "active"
                            : "" || pathname === "/admin/deposit-completed"
                              ? "active"
                              : ""
                  }
                >
                ...
                <li
                  className={
                    pathname === "/admin/withdrawn"
                      ? "active"
                      : "" || pathname === "/admin/withdrawn-pending"
                        ? "active"
                        : "" || pathname === "/admin/withdrawn-cancelled"
                          ? "active"
                          : "" || pathname === "/admin/withdrawn-completed"
                            ? "active"
                            : ""
                  }
                >
                ...
                <li
                  className={
                    pathname === "/admin/transaction"
                      ? "active"
                      : "" || pathname === "/admin/transaction-deposit"
                        ? "active"
                        : "" || pathname === "/admin/transaction-withdraw"
                          ? "active"
                          : "" || pathname === "/admin/transaction-pending"
                            ? "active"
                            : "" || pathname === "/admin/transaction-onhold"
                              ? "active"
                              : "" ||
                                  pathname === "/admin/transaction-completed"
                                ? "active"
                                : ""
                  }
                >
                ...
                <li
                  className={
                    pathname === "/admin/subscription"
                      ? "active"
                      : "" || pathname === "/admin/subscripe-freelancer"
                        ? "active"
                        : "" || pathname === "/admin/view-price-employe"
                          ? "active"
                          : "" || pathname === "/admin/employe-list"
                            ? "active"
                            : "" || pathname === "/admin/freelance-list"
                              ? "active"
                              : "" || pathname === "/admin/view-price-freelance"
                                ? "active"
                                : ""
                  }
                >
                ...
                <li
                  className={
                    pathname === "/admin/verify-identity" ? "active" : ""
                  }
                >
                ...
                <li
                  className={pathname === "/admin/components" ? "active" : ""}
                >
                ...
                <li className="submenu">
                  ...
                  >
                    <li
                      className={
                        pathname === "/admin/form-basic-inputs" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/admin/form-input-groups" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/admin/form-horizontal" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/admin/form-vertical" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/admin/form-mask" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/admin/form-validation" ? "active" : ""
                      }
                    >
                ...
                <li className="submenu">
                  ...
                  >
                    <FeatherIcon icon="align-justify" /> <span> Tables </span>{" "}
                    <span className="menu-arrow" />
                  </Link>
                  <ul
                    style={{
                  ...
                  >
                    ...
                    >
                      <Link to="/admin/tables-basic">Basic Tables </Link>
                    </li>
                    <li
                      className={
                    ...
                    >
                      <Link to="/admin/data-tables"> Data Table </Link>
                    </li>
                  </ul>
                </li>
              </ul>
