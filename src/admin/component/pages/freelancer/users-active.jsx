...
import { icon_01, avatar_10, avatar_14, avatar_15, avatar_16, icon_02, icon_03, icon_04, export_icon, } from '../../pages/imagepath'
const UsersActive = () => {
                    ...
                    <div className='three-dots'>
                        ...
                        <div className="dropdown-menu user-menu-list">
                            ...
                            <form action="#">
                                ...
                                <div className="form-check border-bottom-0">
                                    <input
                                        type="radio"
                                        className="form-check-input"
                                        id="radio3"
                                ...
                                <button type="submit" className="btn btn-primary apply-user mt-3">
                                    Apply
                                </button>
                                <button type="submit" className="btn btn-primary reset-user mt-3">
                                    Reset
                                </button>
                            </form>
                        </div>
