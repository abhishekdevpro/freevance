...
import { icon_01, icon_05, icon_06, icon_07, avatar_10, avatar_14, avatar_15, avatar_16, export_icon } from '../imagepath'
const TransactionCompleted = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <>
                    <Link to="#" className='user-active-btn' data-bs-toggle="modal" data-bs-target="#transaction-category">
                        {text}
                    </Link></>
            ),
                            ...
                            <div className="row">
                                <div className="col-sm-12">
                                    <div className="subscribe-employe users-list">
                                        <ul>
                                            <li>
                                                <Link to="/admin/transaction">All Transaction</Link>
                                            </li>
                                            <li>
                                                <Link to="/admin/transaction-deposit">Deposit</Link>
                                            </li>
                                            <li>
                                                <Link to="/admin/transaction-withdraw">Withdraw</Link>
                                            </li>
                                            <li>
                                                <Link to="/admin/transaction-pending">Pending</Link>
                                            </li>
                                            <li>
                                                <Link to="/admin/transaction-onhold">Onhold</Link>
                                            </li>
                                            <li className="active">
                                                <Link to="/admin/transaction-completed">Completed</Link>
                                            </li>
                                        </ul>
                                    </div>
                                    {/* Active User Header */}
                                    <div className="page-header user-active">
                                        <div className="row align-items-center">
                                            <div className="col">
                                                <h3 className="page-title">Completed</h3>
                                                <p>
