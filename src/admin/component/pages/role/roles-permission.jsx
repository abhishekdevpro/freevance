...
const RolesPermission = () => {
  const options = [
    ...
    { value: 2, label: "Show All Projects" },
    { value: 3, label: "Show Open Projects" },
  ];
  return (
    <>
