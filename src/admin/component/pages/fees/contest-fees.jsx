...
const ContestsFees = () => {
    ...
    const data = [
        {
            id: 1,
            name: "Posting a Contest",
            info: "Free to post a contest and receive entries. A monetary prize must be paid upfront to release as payment for work provided. Optional contest upgrades incur additional costs. Employers are eligible for a 100% money back guarantee.",
            value: "FREE",
        },
        {
            id: 2,
        ...
        {
            id: 3,
            name: "Awarding to additionalfreelancers ",
            info: "There are no fees for awarding additional entries a prize. Payment must be provided equal to the original prize amount for each additional entry awarded.",
            value: "FREE",
        },
    ];
    const columns = [
            ...
            <div className="content container-fluid">
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        <div className="col">
                            <h3 className="page-title">Contest Fees</h3>
                            <ul className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active">Contest Fees</li>
                            </ul>
                        </div>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Add Contests Fees</h4>
                ...
                <div className="modal fade custom-modal" id="edit-category">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Edit Contests Fees</h4>
                                <button type="button" className="close" data-bs-dismiss="modal">
                                    <span>×</span>
                                </button>
                            </div>
