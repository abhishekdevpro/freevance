                            ...
                            <div className="row">
                                <div className="col-sm-12">
                                    <div className="subscribe-employe">
                                        <ul>
                                            <li className="active">
                                                <Link to="admin/employe-list">Employer </Link>
                                            </li>
                                            <li>
                                                <Link to="/admin/freelance-list">Freelancer</Link>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="card ">
                                    ...
                                    <div className="modal-body">
                                        <form>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <select className="form-control form-select" defaultValue="Frontend Developer">
